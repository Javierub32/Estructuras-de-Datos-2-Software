...
// Crear una copia de la lista original y revertirla
      List<Integer> reversedValues = new ArrayList<>(values);
      Collections.reverse(reversedValues);

      // Assert
      assertEquals(reversedValues, stackContents, "El contenido de la pila no coincide con los valores invertidos.");
    }
  }
